...
const Check = () => {
  ...
  const onLogin = async () => {
    ...
    if (res.status === 200) {
      ...
      !userName &&
        !password &&
        setMessage("Please fill in your Username and Password");
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <img src={logoDTU} alt="Duy Tan University" height="77px" />
          </Box>
          <Box
          ...
          >
            ...
            >
              ...
              <Box
                className="loginFormInfoContain"
                sx={{
                  display: "flex",
                  flexDirection: "column",
                  gap: "10px",
              ...
              >
                <Box
                  className="loginFormInfoUsername"
                  sx={{
                    display: "flex",
                    flexDirection: "column",
                    gap: "7px",
                ...
                <Box
                  className="loginFormInfoPassword"
                  sx={{
                    display: "flex",
                    flexDirection: "column",
                    gap: "5px",
